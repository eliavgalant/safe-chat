...
const HowItWorks = () => {
  ...
  const steps = [
    {
      icon: <MessageSquare className="w-12 h-12 text-safechat-gold" />,
      title: "התחברות קלה",
    ...
    <section id="how-it-works" ref={sectionRef} className="container-padding">
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="animate-on-scroll heading-lg gold-text mb-4">איך זה עובד</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div 
              key={index}
              className="animate-on-scroll flex flex-col items-center text-center glass-card rounded-xl p-8 transition-transform duration-300 hover:scale-105"
